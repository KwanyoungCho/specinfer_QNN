...
BINARY="${ROOT_DIR}/build/bin/llama-spec-bench-dynamic-vocab-qnn"
...
if [[ ! -f "$BINARY" ]]; then
    ...
    echo "Build first, or pass --binary /path/to/llama-spec-bench-dynamic-vocab-qnn"
    exit 1
fi
...
echo "=========================================="
echo "  Spec-Bench Dynamic-Vocab QNN"
echo "=========================================="
echo "  Binary:     $BINARY"
